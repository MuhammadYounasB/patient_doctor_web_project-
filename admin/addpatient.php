...
VALUES ('$name',  '	$description','$folder', '$contact' ,  '$email', '$password', '$gender' )";
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Patient Contact Number </label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Patient Disease  </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="disease">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12">Patient Email  </label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Patient Password   </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="pass">
                                        </div>
                                    </div>
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="gender">
      ...
      <option value="OTHER">OTHER</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="submit">Add New  Patient  </button>
                                        </div>
                                    </div>
                                </form>
                    </div>
