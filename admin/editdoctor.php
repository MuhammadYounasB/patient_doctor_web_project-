...
$query= "SELECT * FROM doctor where id = '$edit_id'";
...
$editedescription= $_POST['editedescription'];  
...
$sql = "UPDATE doctor  SET name='$editename', email = '$editemail ' ,	address ='$editaddress',speciality= '$editspeciality',	contact='$editcontact',	gender= '$editgender' , description = '$editedescription', img =  '$folder'	  WHERE id='$edit_id' ";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editname" value="<?php echo $name; ?>" >
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12">Doctor email   </label>
                                        <div class="col-md-12">
                                            <input type="email"  class="form-control form-control-line" name="editemail" value = "<?php echo  $email; ?>">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-md-12">Doctor  Address </label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editaddress" >
                                            <?php echo  $address;  ?>
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"> Doctor Speciality </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editspeciality" value="<?php echo    $speciality  ?>">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-md-12"> Doctor Gender </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editgender" value="<?php echo   $gender  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"> Doctor contact </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editcontact" value="<?php echo   $contact  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Doctor   image </label>
                                        <div class="col-md-12">
                                            <input type="file"  class="form-control form-control-line" name="img"value="<?php echo $img   ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Doctor  Description </label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editedescription"  > <?php echo  $description  ?>
                                            </textarea>
                                        </div>
                                    </div>
