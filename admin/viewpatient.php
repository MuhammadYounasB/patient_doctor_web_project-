                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <td scope="col">Patient Description </td>
                                             <td scope="col">Patient   Image  </td>
                                             <td scope="col">Patient contact information  </td>
  ...
  // output data of each row
   while($row = mysqli_fetch_assoc($result)) {?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['contacinfo']; ?></td>
                                            <td><?php echo $row['email']; ?></td>
                                            <td><?php echo $row['password']; ?></td>
                                            <td><?php echo $row['gender']; ?></td>
                                          
                                            <td><a href="editpatient.php?edit_id=<?php echo $row['p_id'];?>"> Edite </a>
                                               <a href="deletepatient.php?delete_id=<?php echo $row['p_id'];?>" >|| DELETE  </a>  <td>
                                        </tr>
<?php } ?>
