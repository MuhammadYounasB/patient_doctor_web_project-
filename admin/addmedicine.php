...
$sql = "INSERT INTO products (mdname , mddescription , mdimg, price)
VALUES ( '$tittle', '$description','$folder', '$price')";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" >
                          ...
                          <textarea rows="5" class="form-control form-control-line" name ="description"></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="submit">Add Medicine product  </button>
                                        </div>
                                    </div>
                                </form>
                    </div>
