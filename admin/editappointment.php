...
$query= "SELECT * FROM `appointment` WHERE a_id=$edit_id";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editname" value="<?php echo $p_id; ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email"  class="form-control form-control-line" name="editemail" value = "<?php echo  $d_id; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editspeciality" value="<?php echo    $dname  ?>">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-md-12"> Disease name </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editgender" value="<?php echo   $diseasename  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="editcontact" value="<?php echo   $pcontact  ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="date"  class="form-control form-control-line" name="img"value="<?php echo $date   ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="img"value="<?php echo $time   ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">patint message</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editedescription"  > <?php echo  $message  ?>
                                            </textarea>
                                        </div>
                                    </div>
