...
if(isset($_POST['update']))
{
    ...
    $sql = "UPDATE login set name = '$name', email = '$email', pass = '$pass' where id ='$admin_id'  ";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" Value ="<?php echo $_SESSION['name'] ?>" name="name" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" Value="<?php echo $_SESSION['username'] ?>" name="email" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="text" value="<?php echo $_SESSION['pass'] ?>"  name ="pass" class="form-control form-control-line">
                                        </div>
                                    </div>
