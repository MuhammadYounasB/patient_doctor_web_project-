                ...
                <div class="row">
                   <!--my table-->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Number of Doctor  </h4>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <td scope="col">Doctor Adress </td>
                                           
                                            <td scope="col">Doctor  Speciality  </td>
                                            <td scope="col">Doctor  Gender </td>
                                            <td scope="col">Doctor  contact  </td>
                                            <td scope="col">Doctor Descripion  </td>
                                       
                                             
                                            <td scope="col">Doctor   Image  </td>
 ...
 while($row = mysqli_fetch_assoc($result)) {?>
                                        ...
                                        <tr>
                                           ...
                                           <td><img src="<?php echo $row['img']; ?>" height="80px" width="80px" alt="pic"></td>
                                            ...
                                            <td><a href="editdoctor.php?edit_id=<?php echo $row['d_id'];?>"> Edit </a>
                                               <a href="deletedoctor.php?delete_id=<?php echo $row['d_id'];?>" >|| DELETE  </a>  <td>
                                        </tr>
<?php } ?>
