            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="updateadminprofile.php" method="post">
                                    <div class="form-group">
                                        <label class="col-md-12">Full Name</label>
                                        <div class="col-md-12">
                                            <input type="text" Value ="<?php echo $_SESSION['name'] ?>" name="name"  disabled class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" Value="<?php echo $_SESSION['username'] ?>" name="email" disabled class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="password" value="<?php echo $_SESSION['pass'] ?>"  name ="pass" disabled class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                        <a href="updateadminprofile.php?admin_id=<?php echo $_SESSION['admin_id']; ?>" class="btn btn-success btn-lg " role="button" aria-pressed="true">Update profile</a>
                                        </div>
                                    </div>
                                    </div>
                                </form>
