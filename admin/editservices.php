...
$sql = "UPDATE services SET tittle=' $edittittle', description	 = ' $editdescription'   WHERE id='$edit_id' ";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editdescription"  > <?php echo  $description;   ?>
                                            </textarea>
                                        </div>
                                    </div>
