...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['mddescription'] ?> </td>
                                            <td><img src="<?php echo $row['mdimg']; ?>"  height="80px" width="80px" alt="pic"> </td> 
                                            <td><a href="editmedicine.php?edit_id=<?php echo $row['id'] ?>"> Edite </a>
                                               <a href="deletemedicine.php?delete_id=<?php echo  $row['id'] ?>" >|| DELETE  </a>  <td>
                                        </tr>
  <?php } ?>
  <?php } ?>
