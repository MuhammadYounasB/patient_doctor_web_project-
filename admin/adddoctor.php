...
<?php $con = mysqli_connect("localhost","root","","click-medic"); ?> 
    ...
    $sql = "INSERT INTO doctor (name, email , address,speciality,contact,gender, description,img)
    VALUES ('$name', '$email', '$address','$speciality','$contact',' $gender','$description','$folder')";
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data" >
                                    <div class="form-group">
                                        <label class="col-md-12"> Enter Doctor Name </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Enter Email Adress of  Doctor</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Enter   Adress of Doctor  </label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Enter Speciality of Doctor </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="speciality">
                                        </div>
                                        <div class="form-group">
                                        <label class="col-md-12">Enter contact of Doctor </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="contact">
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Enter Gender  </label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line" name="gender">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Enter  Description of Doctor    </label>
                                        <div class="col-md-12">
                               ...
                               <div class="form-group">
                                        <label class="col-md-12">Enter Doctor image  </label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="submit">Add New  Doctor  </button>
                                        </div>
                                    </div>
                                </form>
                    </div>
