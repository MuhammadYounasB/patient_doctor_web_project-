...
$sql = "UPDATE patient   SET name='$editename',  description = '$editedescription', img =  '$folder'  WHERE p_id= $edit_id ";
                    ...
                    <form class="form-horizontal form-material" action="" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="editedescription"  >
