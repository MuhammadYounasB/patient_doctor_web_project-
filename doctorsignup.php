...
$sql = "INSERT INTO doctor (name,	description , address, img, contact , speciality , email, password, gender)
VALUES ('$name',  '$description', '$address','$pic','$contact' , '$speciality', '$email', '$password', '$gender')";
...
<div>
    <ul>
        ...
        <li><a  class="active" href="doctorsignup.php">Doctor Sign Up</a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Registration Info of Doctor </h2>
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="gender">
      ...
      <option value="OTHER">OTHER</option>
                 ...
                 <br>
                   ...
                   <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Doctor speciality" name="speciality">
                        </div>
                        <div class="input-group">
